...
# Project1 - computed the output of the arithmitic solutions f = ( 5 * B * D + A )  and g = ( D * D– C * A )
...
li $v0, 4
la $a0, f2 	# outputs base 2 (binary) value
syscall
li $v0, 35
move $a0, $s0
syscall
...
li $v0, 4
la $a0, g2 	# outputs base 2 (binary) value
syscall
li $v0, 35
move $a0, $s2
syscall
